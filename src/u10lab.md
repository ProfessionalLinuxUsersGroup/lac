...
- **Rocky 9** or an equivalent Linux system
- **Root or sudo access**
...
1. **Pre-Lab: Quick Warmup and System Checks**
2. **Installing K3s and Verifying the Service**
3. **Exploring Kubernetes Environment**
4. **Deploying Applications: Pods, Services, and Deployments**
5. **Troubleshooting Cluster Issues**
6. **Reflection and Additional Challenges**
